...
### *Functionality* 
* I tested all possible user inputs to ensure they were printing the correct data, and I entered incorrect strings in all areas to ensure that incorrect data would not be accepted.
